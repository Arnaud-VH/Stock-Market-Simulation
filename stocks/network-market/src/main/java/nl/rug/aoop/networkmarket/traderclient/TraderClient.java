...
public class TraderClient extends Trader{
     ...
     */
    public TraderClient(String id, String name, double funds, Map<Stock, Long> ownedStocks) {
     ...
     */
    public void placeAsk(Stock stock, long shares, double price) {
        try {
     ...
     */
    public void placeBid(Stock stock, long shares, double price) {
        try {
     ...
     */
    public void updateTrader(double funds, Map<Stock, Long> newStocks) {
        setFunds(funds);
